````md
<h1 align="center">Cash-Crunch - Real-Time Currency Converter</h1>

<p align="center">
  🚀 <strong>Live Demo:</strong><br>
  <a href="https://praveenkumar93924.github.io/Cash-Crunch/" target="_blank">
    https://praveenkumar93924.github.io/Cash-Crunch/
  </a>
</p>
...
Follow these simple steps to convert currencies with Cash-Crunch:
...
Here are some key features of Cash-Crunch:
...
If you prefer to use Docker, you can easily run Cash-Crunch with the provided Docker image.

1. Pull the Docker image from Docker Hub:

```bash
docker pull praveenkumar/cashcrunch-docker-image
````
